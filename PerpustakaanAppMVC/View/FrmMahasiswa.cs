...
namespace PerpustakaanAppMVC.View
{
    public partial class FrmMahasiswa : Form
    {
        ...
        //deklarasi object colection untuk menampung objwk mahasiswa
        ...
        private void btnHapus_Click(object sender, EventArgs e)
        {
            if (lvwMahasiswa.SelectedItems.Count > 0)
            {
                ...
                if (konfirmasi == DialogResult.Yes)
                {
                    ...
                    Mahasiswa mhs =
                    _ = listOfMahasiswa[lvwMahasiswa.SelectedIndices[0]];
        ...
        {
            string cari = txtNama.Text;
                if (cari ==null)
            {
                MessageBox.Show("Anda tidak memasukan nama", "Peringatan",
              MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            lvwMahasiswa.Items.Clear();
            // panggil method ReadAll dan tampung datanya ke dalam collection
            listOfMahasiswa = controller.cari(cari);
            // ekstrak objek mhs dari collection
            foreach (var mhs in listOfMahasiswa)
            {
                var noUrut = lvwMahasiswa.Items.Count + 1;
